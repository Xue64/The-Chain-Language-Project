...
#ifndef CUBECLUB_RS_ASM_DEPRECATED_STRINGCONSTRUCT_H
#define CUBECLUB_RS_ASM_DEPRECATED_STRINGCONSTRUCT_H
...
#endif //CUBECLUB_RS_ASM_DEPRECATED_STRINGCONSTRUCT_H
